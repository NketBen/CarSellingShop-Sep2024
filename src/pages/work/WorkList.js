        ...
        {works.map((work) => (
          ...
          >
            <Link className="contents" to={`/open-work-order/${work.id}`}>
              ...
              Fecha de Inicio: {work.data.timeStart} <br />
              Fecha para Terminar: {work.data.timeFinish}
              <br />
               Imagenes adjuntados:  {work.data.ImgAdjuntado? work.data.ImgAdjuntado : "No imagenes adjuntado"} <br/>
            </Link>
            <div>
              <button
                onClick={() => {
