...
//subida de imagenes a cloud fireStore
...
//guardamos la url de la imagenes en imgUrls
...
//poner todos lo que queremos sube en paraFormCopy
    const paraFormCopy = {
      ...paraForm,
      imgUrls,
      imgAdjuntado: images.length,
      timestamp: serverTimestamp(),
      userRef: auth.currentUser.uid,
    };
    delete paraFormCopy.images;
    !paraFormCopy.previousName && delete paraFormCopy.oldSurname;
    //mandar todos en paraformCopy a coleccion finance
  ...
  if (loading) {
    return <Spinner />; //cuando esta cargando, utliza componente Spinner
  }
  return (
